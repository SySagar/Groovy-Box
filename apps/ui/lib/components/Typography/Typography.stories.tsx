...
export const AlignmentCenter = () => (
  <Text variant="body-1" alignment="center" color="#2A2C35">
...
export const AlignmentLeft = () => (
  <Text variant="body-1" alignment="left" color="#2A2C35">
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
...
export const AlignmentRight = () => (
  <Text variant="body-1" alignment="right" color="#2A2C35">
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
    quis nostrud exercitation ullamco laboris nisi.
  </Text>
...
export const AlignmentJustify = () => (
  <Text variant="body-1" alignment="justify" color="#2A2C35">
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
    quis nostrud exercitation ullamco laboris nisi.
  </Text>
...
export const MaxLinesEllipsis = () => (
  <Text variant="body-2" alignment="left" color="#2A2C35" maxLines={2}>
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
    quis nostrud exercitation ullamco laboris nisi.
  </Text>
...
export const AsChildExample = () => (
  <Text variant="body-1" asChild={true} alignment="center" color="#2A2C35">
